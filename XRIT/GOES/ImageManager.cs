...
namespace OpenSatelliteProject {
    public class ImageManager {
        ...
        public string Folder => organizer.Folder;
        internal bool RunningSingleThread { get; set; }

        private Thread imageThread;
        private bool running;
        private readonly Organizer organizer;
        private readonly string folder;
        static readonly string DefaultShapeFile;
        private readonly string archiveGroup;
        ...
        public void InitMapDrawer() {
            try {
                ...
                if (mapDrawer.ShapeFile != null) return;
                mapDrawer = null;
                ...
                try {
                    ...
                    if (GenerateOtherImages && !mData.IsOtherDataProcessed && mData.OtherData.Count > 0) {
                        mData.OtherData.Keys.ToList().ForEach(k => {
                            ...
                            if (!gd.IsComplete || gd.MaxSegments == 0 || gd.OK) return;
